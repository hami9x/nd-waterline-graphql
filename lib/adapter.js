        ...
        _.forEach(collectionAttributes, function(rules, key) {
          if (rules.hasOwnProperty("model")) {
            ...
            fields[key] = {
              ...
              resolve: function(object) {
                const criteria = {};
                criteria[rules.via] = object[collection.primaryKey];
            ...
            if (rules.type.toLowerCase() == "datetime") {
              fields[key].resolve = object => {
                return object[key] ? object[key].toISOString() : null;
              };
            }
          }
        });
